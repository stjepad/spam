...
const customers = {
    ...
    const eMailsDOM = document.querySelector("#bloop")
    let alleMails = []
//   From that object extract just the customers' email addresses and store them in a new array.

 customers.customers.map(E => {
      alleMails = alleMails.concat(E.contacts.email)
    })
console.log(alleMails)

// foreach through the array called "alleMails" create a section element, determine the text content, and append to the HTML achor
alleMails.forEach(i => {
    const emailSection = document.createElement("section")
    emailSection.textContent = i
    eMailsDOM.appendChild(emailSection)
})